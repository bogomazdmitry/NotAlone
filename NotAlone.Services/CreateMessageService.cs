...
namespace NotAlone.Services
{
    public class CreateMessageService : ICreateMessageService
    {
        ...
        {
            return "P. S. К сожалению, не все так идеально, как хотелось бы, и мы понимаем, что вам может не подойти предложенный партнёр 😓Состав участников неоднороден, кому-то достанется не совсем то, что хотелось, этого не избежать 😢 Но не нужно расстраиваться! Ниже ссылка на беседу, в ней будут люди из числа тех, кто захочет поискать себе партнера среди участников самостоятельно) Эту ссылку получат все участники нашего проекта. Дерзай! ☺ Искренне ваши, команда (не)одиноких.\nhttps://vk.me/join/AJQ1d2xb6B9rZYKlp6wSihIz";
        }
